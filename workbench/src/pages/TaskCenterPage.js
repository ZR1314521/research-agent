...
export default function TaskCenterPage({ api, sessions, onOpen, onRefresh }) {
  ...
  return (
    <main className="task-page page-frame">
      <div className="page-title-row"><div className="page-title"><span className="title-icon">▣</span><div><h1>任务中心</h1><p>状态来自真实后台执行，不估算虚假百分比</p></div></div><button className="primary-action" onClick={() => { setTab("scheduled"); setFormOpen(true); }}>＋ 新建定时任务</button></div>
